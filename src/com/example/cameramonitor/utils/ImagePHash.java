...
public class ImagePHash {
	...
	public String getHash(Bitmap img) throws Exception {
	...
	private Bitmap grayscale(Bitmap img) {
		...
		Bitmap bitgrayscale = Bitmap.createBitmap(img.getWidth(),
				img.getHeight(), Bitmap.Config.RGB_565);
		
		Canvas c = new Canvas(bitgrayscale);
	...
	public int getImagePHash(Bitmap a, Bitmap b) {
		if(a == null || b == null){
			return -1;
		}
		...
		try {
			...
			String image1 = this.getHash(a);
			String image2 = this.getHash(b);


			return this.distance(image1, image2);
		} catch (Exception e) {
